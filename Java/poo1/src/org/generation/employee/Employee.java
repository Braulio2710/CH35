...
public class Employee {
	...
	//2. Método constructor (éste tiene el mismo nombre que la clase, no retorna nada, recibe parámetros (atributos) y los asigna a variables del constructor (this)
